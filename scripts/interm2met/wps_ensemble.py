...
true_lat1 = dom_in.loc[dom_case, 'true_lat1']
true_lat2 = dom_in.loc[dom_case, 'true_lat2']
...
##### Link intermediate WRF files
if True:
    print("Running ungrib...")
    os.system("chmod 777 ./namelist.wps")
    run_ungrib(start_date_str, end_date_str, WPS_case)
    #int_path = '/home/era5_data/interm/%s/%s/ERA5*' % (start_year, start_mo,)
    #ln -sf int_path .
